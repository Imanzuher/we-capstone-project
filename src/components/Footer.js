...
function Footer() {
  return (
    <div>
      <footer class="text-center lg:text-left bg-gray-800 text-gray-50 ">
        <div class="px-64 pt-10 pb-4 text-center md:text-left container">
          <div class="grid grid-cols-4 md:grid-cols-2 lg:grid-cols-4 gap-8 ">
            <div class=" mr-10">
              <h6
                class="
                 uppercase
